...
export default function ResponsiveAppBar() {
  ...
  return (
    ...
    >
      {/* TopBar */}
      <Box
        sx={{ backgroundColor: "#F7F8F8", height: { lg: "32px", sm: "30px" } }}
      >
        <Stack
          direction="row-reverse"
          sx={{
            height: "100%",
            mr: { xs: "15px", sm: "50px", md: "60px", lg: "100px" },
            color: "#7B8082",
          }}
        >
      ...
      <Container
        maxWidth="xl"
        sx={{
          my: { xs: "10px", md: "12px", lg: "13px" },
          paddingX: { md: "100px", lg: "141px" },
        }}
      >
        <Toolbar disableGutters>
            ...
            {navItems.map((item, index) => (
              <Button
                ...
                sx={(theme) => ({
                  ...
                  borderBottom: pathname === item.path ? 1 : 0,
                  borderRadius: 0,
          ...
          <Box>
            <Typography
              sx={{ visibility: "hidden", display: { xs: "flex", md: "none" } }}
            >
              spacer
            </Typography>
          </Box>
